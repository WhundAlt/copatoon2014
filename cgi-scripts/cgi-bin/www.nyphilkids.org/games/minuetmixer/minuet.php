...
<BODY bgColor="#882A0C" ALINK="#FFFFFF" VLINK="#FFFFFF" LINK="#FFFFFF" TEXT="#EEEEEE">
...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	...
	document.write('<PARAM NAME=src VALUE="minuetmixer.dcr">');
	...
	document.write('">\n');
	document.write('<EMBED SRC="minuetmixer.dcr"');
